# 백준 1052 물병
# n개의 물병을 서로(물병은 짝을 이루어 채울 수 있고 용량 제한X) 채워가며 최종적으로 k와 같거나 적은 물이 채워진 물병을 만들 때
# 해당 과정에서 부족한 물병의 총 갯수를 구하는 문제

# 물병은 두 개가 서로 짝을 이루어 채울 수 있고 물이 채워진 상태 => 2진법으로 풀어보자
# 2진법으로 바꾼 다음 역순으로(최종적으로 k개와 같거나 적어야하기 때문에 물이 채워진 상태 즉, 1의 갯수가 k와 같거나 적어야 함)
# 체크하면서 부족한 수량만큼 채워나감
